...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2023 at 07:28 AM
...
(4, 'testx', 'test@gmail.com', '080000000000', 'test', '098f6bcd4621d373cade4e832627b4f6', 'admin-monev', 'test');
...
ALTER TABLE `laporan`
  ...
  ADD KEY `tahun_fk` (`id_tahun`),
  ADD KEY `jenis_paket_fk` (`jenis_paket`),
  ADD KEY `user_fk` (`id_user`),
  ADD KEY `skpk_fk` (`skpk_id`),
  ADD KEY `sumber_dana_fk` (`id_sumber_dana`),
  ADD KEY `kecamatan_fk` (`kecamatan_id`);
...
--
ALTER TABLE `skpk`
  MODIFY `id_skpk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `laporan`
  ADD CONSTRAINT `jenis_paket_fk` FOREIGN KEY (`jenis_paket`) REFERENCES `jenis_paket` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `kecamatan_fk` FOREIGN KEY (`kecamatan_id`) REFERENCES `kecamatan` (`id_kecamatan`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `skpk_fk` FOREIGN KEY (`skpk_id`) REFERENCES `skpk` (`id_skpk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sumber_dana_fk` FOREIGN KEY (`id_sumber_dana`) REFERENCES `sumber_dana` (`id_sumber_dana`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tahun_fk` FOREIGN KEY (`id_tahun`) REFERENCES `tahun` (`id_tahun`) ON DELETE CASCADE ON UPDATE CASCADE,
