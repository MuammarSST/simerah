            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-12">
                        ...
                        <option disabled selected required>--- Silahkan Pilih SKPK ---</option>
                            <?php
                            $i = 0;
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td> <input type="text" class="form-control" id="pl_nama_1" name="pl_nama_1" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">2</th>
                                <td> <input type="text" class="form-control" id="pl_nama_2" name="pl_nama_2" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">3</th>
                                <td> <input type="text" class="form-control" id="pl_nama_3" name="pl_nama_3" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">4</th>
                                <td> <input type="text" class="form-control" id="pl_nama_4" name="pl_nama_4" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">5</th>
                                <td> <input type="text" class="form-control" id="pl_nama_5" name="pl_nama_5" required>
                                </td>
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td> <input type="text" class="form-control" id="pho_nama_1" name="pho_nama_1" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">2</th>
                                <td> <input type="text" class="form-control" id="pho_nama_2" name="pho_nama_2" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">3</th>
                                <td> <input type="text" class="form-control" id="pho_nama_3" name="pho_nama_3" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">4</th>
                                <td> <input type="text" class="form-control" id="pho_nama_4" name="pho_nama_4" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">5</th>
                                <td> <input type="text" class="form-control" id="pho_nama_5" name="pho_nama_5" required>
                                </td>
                            ...
                            <tr>
                                <th scope="row">6</th>
                                <td> <input type="text" class="form-control" id="pho_nama_6" name="pho_nama_6" required>
                                </td>
