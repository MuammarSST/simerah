    ...
    <div class="content">
        ...
        <table id="myTable" class="table table-bordered"
                ...
                <?php 
                            ...
                            $noUrut=1;
                            $data=mysqli_query($koneksi,"SELECT * FROM sumber_dana");
                ...
                <tbody id="dataTable">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#data<?php echo $d['id_sumber_dana']; ?>">
                            ...
                            <!-- Modal Edit Data -->
                            <div class="modal fade" id="data<?php echo $d['id_sumber_dana']; ?>" role="dialog"
                            ...
                            <div class="modal-body">
                             <form action="../proses/sumber-dana-edit.php" method="POST">
                             <div class="mb-2">
                                                    <input type="hidden" name="id_sumber_dana" class="form-control"
