...
?>
    ...
    <div class="container container-fluid">
                ...
                <tbody id="dataTable" class="table-infoo">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-sm btn-secondary fa fa-arrow-repeat mr-2" title="Reset Password"
                                data-bs-toggle="modal" data-bs-target="#resetPassword<?php echo $d['id_user']; ?>"
                                value="<?php echo $d['id_user']; ?>">
                            </button>
                            <button class="btn btn-sm btn-warning fa fa-pencil mr-2" title="Edit" data-bs-toggle="modal"
                                data-bs-target="#dataUserEdit<?php echo $d['id_user']; ?>"
                                value="<?php echo $d['id_user']; ?>"></button>
                            <a href="proses/data-user-hapus?id=<?php echo $d['id_user']; ?>"
                                onClick="return confirm('Apakah anda yakin menghapus data ini?')">
                                <i class="btn btn-sm btn-danger fa fa-trash mr-2" title="Hapus"></i>
                            </a>
                            <!-- Reset Modal-->
                            <div class="modal fade" id="resetPassword<?php echo $d['id_user']; ?>" role="dialog"
                                            ...
                                            <div class="modal-body bg-light">
                                                <div class="mb-4">
                                                    <input type="hidden" name="idUser" class="form-control"
                                                        value="<?php echo $d['id_user']; ?>" readonly />
                                                </div>
                            ...
                            <!-- Modal Edit Data -->
                            <div class="modal fade" id="dataUserEdit<?php echo $d['id_user']; ?>" role="dialog"
                                data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-body bg-light">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="namaLengkap"
                                                        id="namaLengkap" value="<?php echo $d['nama_lengkap']; ?>">
                                                </div>
                                                <div class="input-group mb-2">
        ...
        <!-- Modal Tambah Data -->
        <div class="modal fade" id="dataUserTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group mb-2">
                                <span class="input-group-text col-3">Nama</span>
                                <input type="text" minlength="5" class="form-control" name="namaLengkap"
                                    id="namaLengkap" required placeholder="">
                            </div>
                            <div class="input-group mb-2">
                                <span class="input-group-text col-3">Email</span>
                            ...
                            <div class="input-group mb-2">
                                <span class="input-group-text col-3">Nomor HP</span>
                                <input type="text" minlength="10" class="form-control" name="nomorHp" id="nomorHp"
                                    required placeholder="">
                            </div>
                            <div class="input-group mb-2">
                                <span class="input-group-text col-3">Username</span>
                                <input type="text" minlength="5" class="form-control" name="username" id="username"
                                    required placeholder="">
                            </div>
                            <div class="input-group mb-2">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <select class="form-select form-control" id="level" name="level" required>
                                    <option value="" disabled selected>Pilih Level<i class="fa fa-level-up"
